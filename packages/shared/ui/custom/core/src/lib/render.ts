import { ElementData, ElementProps } from './template/types'
...
export abstract class CustomElement extends HTMLElement {
  ...
  queryData<K extends keyof HTMLElementTagNameMap>(selector: K) {
    type SelectElement = ElementData<HTMLElementTagNameMap[K]>
    if (!this.shadowRoot) return
    return this.shadowRoot.querySelector<SelectElement>(selector)
  }
